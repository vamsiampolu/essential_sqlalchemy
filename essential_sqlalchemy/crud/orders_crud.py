from sqlalchemy.sql import insert, select, func
from essential_sqlalchemy.models.order import Order, OrderList
from essential_sqlalchemy.models.customer_order import CustomerOrderList, CustomerOrder
...
class Orders:
    ...
    def get_order_count_per_user(self):
    ...
    def find_orders(self, customer_name: str, details=False):
